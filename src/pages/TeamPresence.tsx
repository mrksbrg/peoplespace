...
import { teams, teamMembers } from '@/data/teamData'
...
const TeamPresence = () => {
  ...
  const zones = [
    ...
    { name: 'Collaboration', position: { x: 45, y: 45, width: 30, height: 25 } },
  ]
  ...
  const getPositionForLocation = (location: string | null) => {
    ...
    if (location.includes('Collaboration')) return { x: 60, y: 57 }
